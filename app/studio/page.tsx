...
function Studio() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">Slideshow studio</h1>
      ...
      <div className="card space-y-4 px-5 py-4">
        <label className="flex flex-col gap-1.5">
          <span className="muted text-xs font-medium uppercase tracking-wide">Hook</span>
          <input
            value={hook}
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <label className="flex flex-col gap-1.5">
            <span className="muted text-xs font-medium uppercase tracking-wide">Slides</span>
            <select
              value={slideCount}
          ...
          <button
            ...
            disabled={busy}
            className="self-end rounded-lg px-5 py-2.5 text-sm font-medium text-white disabled:opacity-50"
...
function SlideEditor({
  ...
  return (
    <article className="card grid gap-5 px-5 py-5 md:grid-cols-[220px_minmax(0,1fr)]">
      ...
      <div className="space-y-3">
        ...
        <label className="flex flex-col gap-1.5">
          <span className="muted text-xs font-medium uppercase tracking-wide">On-image text</span>
          <textarea
        ...
        <label className="flex flex-col gap-1.5">
          <span className="muted text-xs font-medium uppercase tracking-wide">Supporting line</span>
          <input
            value={slide.subText ?? ""}
        ...
        <div>
          <p className="muted text-xs font-medium uppercase tracking-wide">Picture brief</p>
  ...
  return (
    <div className="flex flex-wrap items-end gap-4 text-sm">
      <div className="flex flex-col gap-1.5">
        <span className="muted text-xs font-medium uppercase tracking-wide">Look</span>
        <div className="flex gap-2">
          {PRESETS.map((preset) => (
            <button
              ...
              style={{
                borderColor:
                  style.background === preset.style.background ? "var(--lift)" : "var(--border)",
              }}
            >
              {preset.label}
            </button>
      ...
      <label className="flex flex-col gap-1.5">
        <span className="muted text-xs font-medium uppercase tracking-wide">Text position</span>
        <select
          value={style.align}
